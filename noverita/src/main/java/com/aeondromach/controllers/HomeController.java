...
public class HomeController {
    ...
    @FXML protected void initialize() {
        Platform.runLater(() -> {
            ...
            // Test Characters
            CHARACTERS.add(new CharView("Evelyn", "Developer", "The Englemans", 9, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Aiden", "Writer", "The Eaglesons", 2, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Adam", "Worker", "The Eagles", 1, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));

            CHARACTERS.add(new CharView("George", "King", "The Welkins", 6, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Georgina", "Librarian", "The Welki", 5, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Jeannine", "Priestess", "The Welkins", 3, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));

            CHARACTERS.add(new CharView("Bodger", "Blacksmith", "The Bodgers", 9, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Dark Bodger", "Bodger", "The Bodgers", 9, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Quare", "Child", "The Bodgers", 9, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Pudgy", "Dead Body", "The Bodgers", 9, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            CHARACTERS.add(new CharView("Lodger", "Mother", "The Bodgers", 9, new Image(new File("noverita/src/main/resources/com/aeondromach/images/AeondromachBackground.png").toURI().toString())));
            ...
            for (String squad: SQUADS) {
                ...
                if (!squad.equals(SQUADS.get(SQUADS.size() - 1))) {
                    squadPane.setStyle("-fx-padding: 0 0 5 15; -fx-background: red; -fx-spacing: 7;");
                }
                else { 
                    squadPane.setStyle("-fx-padding: 0 0 0 15; -fx-background: red; -fx-spacing: 7;");
                }
                ...
                squadLine.setStyle("-fx-stroke: -tertiaryColor; -fx-stroke-width: 3;");
                ...
                squadHold.setMaxWidth(vBoxCharHub.getPrefWidth() - 20);
                squadHold.setPrefWidth(vBoxCharHub.getPrefWidth() - 20);

                double marginX = 200, marginY = 185, marginInX = 30, marginInY = 15;

                for (int i = 0; i < CHARACTERS.size(); i++) {
                    CharView character = CHARACTERS.get(i);
                    if (character.getSquad().equals(squad)) {
                        AnchorPane charMargin = new AnchorPane();
                        ...
                        charHold.setLayoutX(marginInX / 2);
                        charHold.setLayoutY(marginInY / 2);
                        ...
                        charImage.setLayoutX(4);
                        charImage.setLayoutY(4);
                        charImage.setOpacity(0.8);

                        VBox charHighlight = new VBox();
                        charHighlight.setAlignment(Pos.TOP_LEFT);
                        charHighlight.setPrefWidth(charHold.getPrefWidth());
                        charHighlight.setPrefHeight(70);
                        charHighlight.setLayoutY((marginY - marginInY) - 66);
                        ...
                        Platform.runLater(() -> {
                            System.out.println(charHighlight.getWidth() + " | " + charHold.getWidth());
                        });
                    }
                }
